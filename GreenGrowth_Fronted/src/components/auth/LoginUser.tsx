...
const LoginUser: React.FC = () => {
  ...
  const validateForm = (): string | null => {
    if (!username.trim() || !password.trim()) return 'Complete usuario y contraseña.';
    if (username.trim().length < 3) return 'El usuario debe tener mínimo 3 caracteres.';
    return null;
  };
  ...
  return (
    <div style={styles.pageContainer}>
      <button onClick={() => navigate('/reportList')} style={styles.backButton} type="button">
        ← Back to Report List
      </button>
      ...
      <div style={styles.formWrapper}>
        ...
        <div style={{ textAlign: 'center', marginTop: '16px' }}>
          <p style={{ fontSize: '14px', color: '#718096' }}>
            ...
            <Link to="/register" style={{ color: '#9cdb5f', textDecoration: 'underline' }}>
              Register here
            </Link>
          </p>
        </div>
